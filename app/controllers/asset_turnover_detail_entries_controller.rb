class AssetTurnoverDetailEntriesController < ApplicationController
  ...
  private
    ...
    def asset_turnover_detail_entry_params
      params.require(:asset_turnover_detail_entry).permit(:assetcards_Code, :assetcards_name, :Unit, :Amount, :Reasons_for, :_borrowing, :givebackPlanDate, :Has_Been_returned, :givebackDate, :Deptment, :Employeeld, :Asset_seat, :Last_seat, :AssetTurnoverDetail_id)
    end
end
